...
class TestRectangle_height(unittest.TestCase):
    """Tests initialization of Rectangle height attribute."""
...
class TestRectangle_x(unittest.TestCase):
    """Tests initialization of x attribute."""
...
class TestRectangle_y(unittest.TestCase):
    """Tests initialization of y attribute."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Tests Rectangle order of attribute initialization."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittests for testing __str__ and display method."""

    @staticmethod
    def capture_stdout(rect, method):
        """Returns text printed to stdout by calling method on sq"""
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
            print(rect)
